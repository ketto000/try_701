...
public class EgovWebLogController {
	...
	@RequestMapping(value="/sym/log/wlg/SelectWebLogList_nexacro.do")
	public NexacroResult selectWebLogInf_nexacro(@ParamDataSet( name= "searchVO") WebLog webLog,
			ModelMap model) throws Exception{
	...
	@RequestMapping(value="/sym/log/wlg/SelectWebLogDetail_nexacro.do")
	public NexacroResult selectWebLog_nexacro(@ParamDataSet( name = "searchVO") WebLog webLog,
