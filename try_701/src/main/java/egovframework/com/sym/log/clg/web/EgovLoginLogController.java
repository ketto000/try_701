...
public class EgovLoginLogController {
	...
	@RequestMapping(value="/sym/log/clg/SelectLoginLogList_nexacro.do")
	public NexacroResult selectLoginLogInf_nexacro(@ParamDataSet(name ="searchVO") LoginLog loginLog,
			ModelMap model) throws Exception{
	...
	@RequestMapping(value="/sym/log/clg/SelectLoginLogDetail_nexacro.do")
	public NexacroResult selectLoginLog_nexacro(@ParamDataSet( name="searchVO") LoginLog loginLog,
			@ParamVariable(name = "logId") String logId,
			ModelMap model) throws Exception{
