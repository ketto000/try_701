...
public class EgovPrivacyLogController {
	...
	@RequestMapping(value="/sym/log/plg/SelectPrivacyLogList_nexacro.do")
	public NexacroResult selectPrivacyLogList_nexacro(@ParamDataSet( name= "searchVO") PrivacyLog privacyLog,
			ModelMap model) throws Exception{
		...
		nexacro_Result.addDataSet("resultList", map.get("resultList"));
		nexacro_Result.addDataSet("resultCnt", map.get("resultCnt"));
	...
	@RequestMapping(value="/sym/log/plg/SelectPrivacyLogDetail_nexacro.do")
	public NexacroResult selectWebLog_nexacro(@ParamDataSet(name = "searchVO") PrivacyLog privacyLog,
			ModelMap model) throws Exception{

		NexacroResult nexacro_Result = new NexacroResult();	
		nexacro_Result.addDataSet("result", privacyLogService.selectPrivacyLog(privacyLog));
