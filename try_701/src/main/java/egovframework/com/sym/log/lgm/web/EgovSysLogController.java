...
public class EgovSysLogController {
	...
	@IncludedInfo(name="로그관리", listUrl="/sym/log/lgm/SelectSysLogList_nexacro.do", order = 1030 ,gid = 60)
	@RequestMapping(value="/sym/log/lgm/SelectSysLogList_nexacro.do")
	public NexacroResult selectSysLogInf_nexacro(@ParamDataSet(name ="searchVO") SysLog sysLog,
			ModelMap model) throws Exception{
		...
		nexacroResult.addDataSet("frm", sysLog);
	...
	@RequestMapping(value="/sym/log/lgm/SelectSysLogDetail_nexacro.do")
	public NexacroResult selectSysLog_nexacro(@ParamDataSet(name ="searchVO") SysLog sysLog, 
			@ParamVariable(name="requstId") String requstId,
			ModelMap model) throws Exception{
