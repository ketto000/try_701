            ...
            "Form" :
            			...
            			"Calendar" :
            			{
            				"self" :
            				{
            					...
            					"mouseover" :
            					{
            						"border" : nexacro.BorderObject("1px solid #834694")
            					},
            					"focused" :
            					{
            						"border" : nexacro.BorderObject("1px solid #834694")
            			...
            			"Grid" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("2px solid #6f397e, 1px solid #c7c7c7, 1px solid #c7c7c7, 1px solid #c7c7c7")
            					}
            				},
            				"class" :
            				[
            					...
            					},
            					{
            						"sta_WF_pagingNum" :
            						{
            							"self" :
            							{
            								...
            								"disabled" :
            								{
            									"color" : nexacro.ColorObject("#834694"),
            				...
            				"parent" :
            				{
            					"Tab" :
            					{
            						"self" :
            						{
            							...
            							{
            								"color" : nexacro.ColorObject("#101010"),
            								"border" : nexacro.BorderObject("1px solid #834694, 1px solid #c7c7c7, 1px solid #ffffff, 1px solid #c7c7c7")
            							},
            							"focused_selected" :
            							{
            								"color" : nexacro.ColorObject("#101010"),
            					...
            					"DatePickerControl" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								...
            								"border" : nexacro.BorderObject("1px solid #834694, 1px solid #697888, 1px solid #697888, 1px solid #697888")
            							},
            							"disabled" :
            							{
