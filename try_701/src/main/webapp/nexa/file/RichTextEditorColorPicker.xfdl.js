(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_image("URL(\'Images::color_picker/colorDialog.JPG\')");
            obj.set_stretch("fit");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("82");
            obj.set_tabstop("false");
            obj.set_image("URL(\'Images::color_picker/select.GIF\')");
            this.addChild(obj.name, obj);

            obj = new ImageViewer("slider","505","45","9","15",null,null,null,null,null,null,this);
            obj.set_taborder("83");
            obj.set_tabstop("false");
            obj.set_image("URL(\'Images::color_picker/left_arrow.png\')");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("RichTextEditorColorPicker.xfdl", function() {
        /**
        ...
        this.ColorPickerPopup_onload = function(obj, e)
        {
        	...
        	Eco.XComp.Event.makeDraggable(this.selectPointer, draggingFunc, this, [this.selectPointer]);
        	...
        	Eco.XComp.Event.makeDraggable(this.slider, draggingFunc2, this, [this.slider]);
        }
        ...
        this.loadColor = function(value)
        {
        	...
        	for(var i=0; i<verticalLen; i++)
        	{
        		...
        		for(var j=0; j<horizontalLen; j++)
        		{
        			...
        			color += " URL('Images::color_picker/sta_clrBox.png')";
        	...
        	for( i = 0 ; i < 16 ; i++ )
        	{
        		...
        		if(userColor)
        		{
        			...
        			userColor = userColor + " URL('Images::color_picker/sta_clrBox.png')";
        ...
        this.onPointerDragStart = function(comp)
        {

        }

        // dragging 시 처리할 루틴을 정의한 함수
        this.onPointerDragging = function(offsetX, offsetY, obj)
        {
        	var nextX = obj.getOffsetLeft() + offsetX;
        	var nextY = obj.getOffsetTop() + offsetY;
        ...
        // drag 가 발생될 때 처리할 루틴을 정의한 함수
        this.onSliderDragStart = function(comp){}


        // dragging 시 처리할 루틴을 정의한 함수
        this.onSliderDragging = function(offsetX, offsetY, obj)
        {
           var nextY = obj.getOffsetTop() + offsetY;
        ...
        // //ondrag event에서 true를 해줘야 ondragmove event가 발생함.
        // this.colorImage_ondragmove = function(obj:ImageViewer, e:nexacro.DragEventInfo)
        // {
        ...
        // }
        //
        // //ondragmove event를 발생시키기 위해 true를 return.
        ...
        this.btnAddUserColor_onclick = function(obj,  e)
        {
        	...
        	bg = bg + " URL('Images::color_picker/sta_clrBox.png')";
        ...
        this.loadIncludeScript("RichTextEditorColorPicker.xfdl");
