(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("userlog_View.xfdl","board::langCnt.xjs");
        this.registerScript("userlog_View.xfdl", function() {
        ...
        ************************************************************************/
        ...
        // this.srvcNm="";
        // this.methodNm="";
        this.form_title_name="사용자 로그 목록";
        this.form_search_tit="사용자";
        ...
        ************************************************************************/
        ...
        {
        	this.div_log_view.set_url("log::userlog_List.xfdl");
        };
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("userlog_View.xfdl");
