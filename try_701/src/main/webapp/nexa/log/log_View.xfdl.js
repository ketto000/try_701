(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("log_View.xfdl","board::langCnt.xjs");
        this.registerScript("log_View.xfdl", function() {
        ...
        ************************************************************************/
        ...
        this.form_title_name="로그 상세조회";
        this.form_search_tit="처리구분";
        ...
        ************************************************************************/
        ...
        this.board_View_onload = function(obj,e)
        {
        	...
        	this.div_log_view.set_url("log::log_List.xfdl");
        };
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("log_View.xfdl");
