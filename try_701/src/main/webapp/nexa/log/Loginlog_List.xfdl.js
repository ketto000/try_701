(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"64\"/><Column size=\"105\"/><Column size=\"100\"/><Column size=\"149\"/><Column size=\"105\"/><Column size=\"72\"/><Column size=\"48\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"로그ID\"/><Cell col=\"2\" text=\"발생일자\"/><Cell col=\"3\" text=\"접속방식\"/><Cell col=\"4\" text=\"사용자명\"/><Cell col=\"5\" text=\"접속IP\"/><Cell col=\"6\" text=\"상세보기\"/></Band><Band id=\"body\"><Cell text=\"bind:rowNo\"/><Cell col=\"1\" text=\"bind:loginId\"/><Cell col=\"2\" text=\"bind:creatDt\"/><Cell col=\"3\" text=\"bind:loginMthd\"/><Cell col=\"4\" text=\"bind:loginNm\"/><Cell col=\"5\" text=\"bind:loginIp\"/><Cell col=\"6\" displaytype=\"buttoncontrol\" edittype=\"button\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("Loginlog_List.xfdl","log::pagging.xjs");
        this.registerScript("Loginlog_List.xfdl", function() {
        ...
        */
        ...
        this.fnSearchPagging = function(nPageNo)
        {
        	...
        	var sId 	= "PAGE";
        	var sUrl 	= "svcUrl::/sym/log/clg/SelectLoginLogList_nexacro.do";
        ...
        */
        ...
        this.Grid00_oncellclick = function(obj,e)
        {
        	...
        	if(e.col == "6"){
        		this.parent.loginId=this.resultList.getColumn(e.row, "logId");
        		this.parent.set_url("log::Loginlog_Detail.xfdl");
        		}
        ...
        */
        ...
        this.loadIncludeScript("Loginlog_List.xfdl");
