(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"64\"/><Column size=\"105\"/><Column size=\"100\"/><Column size=\"149\"/><Column size=\"105\"/><Column size=\"72\"/><Column size=\"48\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"요청ID\"/><Cell col=\"2\" text=\"발생일자\"/><Cell col=\"3\" text=\"URL\"/><Cell col=\"4\" text=\"요청자\"/><Cell col=\"5\" text=\"요청자IP\"/><Cell col=\"6\" text=\"상세보기\"/></Band><Band id=\"body\"><Cell text=\"bind:rowNo\"/><Cell col=\"1\" text=\"bind:requstId\"/><Cell col=\"2\" text=\"bind:occrrncDe\"/><Cell col=\"3\" text=\"bind:url\"/><Cell col=\"4\" text=\"bind:rqsterNm\"/><Cell col=\"5\" text=\"bind:rqesterIp\"/><Cell col=\"6\" displaytype=\"buttoncontrol\" edittype=\"button\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("Weblog_List.xfdl","log::pagging.xjs");
        this.registerScript("Weblog_List.xfdl", function() {
        ...
        */
        ...
        this.fnSearchPagging = function(nPageNo)
        {
        	...
        	var sId 	= "PAGE";
        	var sUrl 	= "svcUrl::sym/log/wlg/SelectWebLogList_nexacro.do";
        ...
        */
        ...
        this.Grid00_oncellclick = function(obj,e)
        {
        	...
        	if(e.col == "6"){
        		...
        		this.parent.set_url("log::Weblog_Detail.xfdl");
        		}
        ...
        */
        ...
        this.loadIncludeScript("Weblog_List.xfdl");
