    ...
    return function(path)
    {
        ...
        */
        ...
        //			objConfig.objSearchButton.status = "init";
        	...
        	objDiv.config.nMoveBtnHeight	= 30;	//button height (common)
        	objDiv.config.nMoveBtnWidth		= 35;	//comm move button & edit width
        	objDiv.config.nMoveCountBtnWidth= 35;	//comm number button width
        	...
        	objDiv.config.btnNumClass	 = "paging";	//comm.page number class
