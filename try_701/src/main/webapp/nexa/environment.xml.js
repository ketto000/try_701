if (nexacro.Environment)
{
    ...
    {
        this.set_themeid("theme::violet");
        this.set_datatyperule("2.0");
        this.set_loadingimage("url(\'imagerc::loading_2023.jpg\')");
    };
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcUrl", "JSP", "http://localhost:8085/try_701", "none", null, "", "0", "0");
        nexacro._addService("file", "file", "./file/", "session", null, "", "0", "0");
        nexacro._addService("utill", "form", "./utill/", "session", null, "", "0", "0");
        nexacro._addService("log", "form", "./log/", "session", null, "", "0", "0");
