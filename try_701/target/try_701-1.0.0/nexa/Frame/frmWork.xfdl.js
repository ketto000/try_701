(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staTitle","10","0",null,"34","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("메뉴명입니다.");
        ...
        this.fnInitForm = function (){
        	...
        	/*
        		workFrame에 Frame이 생성될 때 추가된 파라미터 정보 가져오기
        		(frmLeftform의 fnOpenMenu 함수에서 생성한 Frame에cnrk
