(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"title_kr\" type=\"STRING\" size=\"256\"/><Column id=\"title_en\" type=\"STRING\" size=\"256\"/><Column id=\"index_column\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"title_kr\">발생일자</Col><Col id=\"index_column\">occrrncDe</Col><Col id=\"title_en\">requstId</Col></Row><Row><Col id=\"title_kr\">사용자</Col><Col id=\"index_column\">rqsterNm</Col><Col id=\"title_en\">요청ID</Col></Row><Row><Col id=\"title_kr\">서비스명</Col><Col id=\"index_column\">srvcNm</Col></Row><Row><Col id=\"title_kr\">메소드명</Col><Col id=\"index_column\">methodNm</Col></Row><Row><Col id=\"title_kr\">생성</Col><Col id=\"index_column\">creatCo</Col></Row><Row><Col id=\"title_kr\">수정</Col><Col id=\"index_column\">updtCo</Col></Row><Row><Col id=\"title_kr\">조회</Col><Col id=\"index_column\">rdCnt</Col></Row><Row><Col id=\"title_kr\">삭제</Col><Col id=\"index_column\">deleteCo</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("userlog_Detail.xfdl","board::langCnt.xjs");
        this.registerScript("userlog_Detail.xfdl", function() {
        ...
        ************************************************************************/
        ...
        this.board_Detail_onload = function(obj,e)
        {
        	...
        	var strParam1=this.parent.rqesterId; //DIV할당된 변수

        	alert(strParam1);
        	var strParam2=this.parent.occrrncDe; //DIV할당된 변수
        	var strParam3=this.parent.srvcNm; //DIV할당된 변수
        	var strParam4=this.parent.methodNm; //DIV할당된 변수

        	this.fnSearchDetail(strParam1,strParam2,strParam3,strParam4);
        };


        this.fnSearchDetail = function(rqesterId, occrrncDe, srvcNm, methodNm)
        {
        ...
        //	this.searchVO.setColumn(0,"bbsId"  , request_id);
        	...
        	var sId 	= "Detail";
        	var sUrl 	= "svcUrl::/sym/log/ulg/SelectUserLogDetail_nexacro.do";
        	var sInDs 	= "searchVO=searchVO";
        	var sOutDs 	= "result_data=result_data";
        	var sParam 	= "occrrncDe="+occrrncDe+" rqesterId="+rqesterId+" srvcNm="+srvcNm+" methodNm="+methodNm;
        ...
        ************************************************************************/
        ...
        {
        	this.parent.set_url("log::userlog_List.xfdl");
        };
        ...
        this.loadIncludeScript("userlog_Detail.xfdl");
