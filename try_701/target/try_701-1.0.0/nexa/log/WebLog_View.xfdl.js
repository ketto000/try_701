(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("PrivacyLog_View_copy0.xfdl","board::langCnt.xjs");
        this.registerScript("PrivacyLog_View_copy0.xfdl", function() {
        ...
        ************************************************************************/
        ...
        // this.methodNm="";
        this.loginId="";
        this.form_title_name="개인정보로그 상세조회";
        this.form_search_tit="조회정보";
        this.form_btn_option="0";
        ...
        ************************************************************************/
        ...
        this.Loginlog_View_onload = function(obj,e)
        {
        	this.div_log_view.set_url("log::PrivacyLog_List.xfdl");
        };
        ...
        ************************************************************************/
        ...
        {
            this.addEventHandler("onload",this.Loginlog_View_onload,this);
        };
        this.loadIncludeScript("PrivacyLog_View_copy0.xfdl");
