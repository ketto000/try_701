(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"logId\" type=\"STRING\" size=\"256\"/><Column id=\"loginId\" type=\"STRING\" size=\"256\"/><Column id=\"loginNm\" type=\"STRING\" size=\"256\"/><Column id=\"loginIp\" type=\"STRING\" size=\"256\"/><Column id=\"loginMthd\" type=\"STRING\" size=\"256\"/><Column id=\"errOccrrAt\" type=\"STRING\" size=\"256\"/><Column id=\"errorCode\" type=\"STRING\" size=\"256\"/><Column id=\"creatDt\" type=\"STRING\" size=\"256\"/><Column id=\"searchBgnDe\" type=\"STRING\" size=\"256\"/><Column id=\"searchCnd\" type=\"STRING\" size=\"256\"/><Column id=\"searchEndDe\" type=\"STRING\" size=\"256\"/><Column id=\"searchWrd\" type=\"STRING\" size=\"256\"/><Column id=\"sortOrdr\" type=\"STRING\" size=\"256\"/><Column id=\"searchUseYn\" type=\"STRING\" size=\"256\"/><Column id=\"pageIndex\" type=\"INT\" size=\"256\"/><Column id=\"pageUnit\" type=\"INT\" size=\"256\"/><Column id=\"pageSize\" type=\"INT\" size=\"256\"/><Column id=\"firstIndex\" type=\"INT\" size=\"256\"/><Column id=\"lastIndex\" type=\"INT\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"INT\" size=\"256\"/><Column id=\"rowNo \" type=\"INT\" size=\"256\"/><Column id=\"searchBgnDeView\" type=\"STRING\" size=\"256\"/><Column id=\"searchEndDeView\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"logId\"/><Col id=\"loginId\"/><Col id=\"loginNm\"/><Col id=\"loginIp\"/><Col id=\"loginMthd\"/><Col id=\"errOccrrAt\"/><Col id=\"errorCode\"/><Col id=\"creatDt\"/><Col id=\"searchBgnDe\"/><Col id=\"searchCnd\"/><Col id=\"searchEndDe\"/><Col id=\"searchWrd\"/><Col id=\"sortOrdr\"/><Col id=\"searchUseYn\"/><Col id=\"pageIndex\">1</Col><Col id=\"pageUnit\">10</Col><Col id=\"pageSize\">10</Col><Col id=\"firstIndex\">1</Col><Col id=\"lastIndex\">1</Col><Col id=\"recordCountPerPage\">10</Col><Col id=\"rowNo \">0</Col><Col id=\"searchBgnDeView\"/><Col id=\"searchEndDeView\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("searchVO", this);
            obj._setContents("<ColumnInfo><Column id=\"logId\" type=\"STRING\" size=\"256\"/><Column id=\"loginId\" type=\"STRING\" size=\"256\"/><Column id=\"loginNm\" type=\"STRING\" size=\"256\"/><Column id=\"loginIp\" type=\"STRING\" size=\"256\"/><Column id=\"loginMthd\" type=\"STRING\" size=\"256\"/><Column id=\"errOccrrAt\" type=\"STRING\" size=\"256\"/><Column id=\"errorCode\" type=\"STRING\" size=\"256\"/><Column id=\"creatDt\" type=\"STRING\" size=\"256\"/><Column id=\"searchBgnDe\" type=\"STRING\" size=\"256\"/><Column id=\"searchCnd\" type=\"STRING\" size=\"256\"/><Column id=\"searchEndDe\" type=\"STRING\" size=\"256\"/><Column id=\"searchWrd\" type=\"STRING\" size=\"256\"/><Column id=\"sortOrdr\" type=\"STRING\" size=\"256\"/><Column id=\"searchUseYn\" type=\"STRING\" size=\"256\"/><Column id=\"pageIndex\" type=\"INT\" size=\"256\"/><Column id=\"pageUnit\" type=\"INT\" size=\"256\"/><Column id=\"pageSize\" type=\"INT\" size=\"256\"/><Column id=\"firstIndex\" type=\"INT\" size=\"256\"/><Column id=\"lastIndex\" type=\"INT\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"INT\" size=\"256\"/><Column id=\"rowNo \" type=\"INT\" size=\"256\"/><Column id=\"searchBgnDeView\" type=\"STRING\" size=\"256\"/><Column id=\"searchEndDeView\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"loginNm\"/><Col id=\"loginIp\"/><Col id=\"loginMthd\"/><Col id=\"errOccrrAt\"/><Col id=\"errorCode\"/><Col id=\"creatDt\"/><Col id=\"searchBgnDe\"/><Col id=\"searchCnd\"/><Col id=\"searchEndDe\"/><Col id=\"searchWrd\"/><Col id=\"sortOrdr\"/><Col id=\"searchUseYn\"/><Col id=\"pageIndex\">1</Col><Col id=\"pageUnit\">10</Col><Col id=\"pageSize\">10</Col><Col id=\"firstIndex\">1</Col><Col id=\"lastIndex\">1</Col><Col id=\"recordCountPerPage\">10</Col><Col id=\"rowNo \">0</Col><Col id=\"searchBgnDeView\"/><Col id=\"searchEndDeView\"/><Col id=\"loginId\"/><Col id=\"logId\"/></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("detail_data", this);
            obj._setContents("<ColumnInfo><Column id=\"title_kr\" type=\"STRING\" size=\"256\"/><Column id=\"title_en\" type=\"STRING\" size=\"256\"/><Column id=\"index_column\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"title_kr\">로그ID</Col><Col id=\"index_column\">logId</Col><Col id=\"title_en\">requstId</Col></Row><Row><Col id=\"title_kr\">발생일자</Col><Col id=\"index_column\">creatDt</Col><Col id=\"title_en\">요청ID</Col></Row><Row><Col id=\"title_kr\">로그유형</Col><Col id=\"index_column\">loginMthd</Col></Row><Row><Col id=\"title_kr\">사용자</Col><Col id=\"index_column\">loginNm</Col></Row><Row><Col id=\"title_kr\">접속IP</Col><Col id=\"index_column\">loginIp</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("Loginlog_Detail.xfdl","board::langCnt.xjs");
        this.registerScript("Loginlog_Detail.xfdl", function() {
        ...
        ************************************************************************/
        this.board_Detail_onload = function(obj,e)
        {
        	...
        	var strParam1=this.parent.loginId; //DIV할당된 변수
        	alert(strParam1);
        ...
        this.fnSearchDetail = function(strParam1)
        {
        	...
        	var sId 	= "Detail";
        	var sUrl 	= "svcUrl::/sym/log/clg/SelectLoginLogDetail_nexacro.do";
        	var sInDs 	= "searchVO=searchVO";
        	var sOutDs 	= "result_data=result";
        	var sParam 	= "logId="+strParam1;
        ...
        ************************************************************************/
        ...
        {
        	this.parent.set_url("log::Loginlog_List.xfdl");
        };
        ...
        this.loadIncludeScript("Loginlog_Detail.xfdl");
