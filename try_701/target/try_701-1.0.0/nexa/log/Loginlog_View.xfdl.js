(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("Loginlog_View.xfdl","board::langCnt.xjs");
        this.registerScript("Loginlog_View.xfdl", function() {
        ...
        ************************************************************************/
        ...
        // this.methodNm="";
        this.loginId="";
        this.form_title_name="접속 로그 목록";
        this.form_search_tit="접속방식";
        ...
        ************************************************************************/
        ...
        {
        	this.div_log_view.set_url("log::Loginlog_List.xfdl");
        };
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("Loginlog_View.xfdl");
