(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"title_kr\" type=\"STRING\" size=\"256\"/><Column id=\"title_en\" type=\"STRING\" size=\"256\"/><Column id=\"index_column\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"title_kr\">요청ID</Col><Col id=\"index_column\">requstId</Col><Col id=\"title_en\">requstId</Col></Row><Row><Col id=\"title_kr\">발생일자</Col><Col id=\"index_column\">occrrncDe</Col><Col id=\"title_en\">요청ID</Col></Row><Row><Col id=\"title_kr\">송수신구분</Col><Col id=\"index_column\">trsmrcvSeCodeNm</Col></Row><Row><Col id=\"title_kr\">연계ID</Col><Col id=\"index_column\">cntcId</Col></Row><Row><Col id=\"title_kr\">제공기관ID</Col><Col id=\"index_column\">provdInsttId</Col></Row><Row><Col id=\"title_kr\">제공시스템ID</Col><Col id=\"index_column\">provdSysId</Col></Row><Row><Col id=\"title_kr\">제공서비스ID</Col><Col id=\"index_column\">provdSvcId</Col></Row><Row><Col id=\"title_kr\">요청기관ID</Col><Col id=\"index_column\">requstInsttId</Col></Row><Row><Col id=\"title_kr\">요청시스템ID</Col><Col id=\"index_column\">requstSysId</Col></Row><Row><Col id=\"title_kr\">요청자</Col><Col id=\"index_column\">rqsterNm</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("Trsmrcv_Detail.xfdl","board::langCnt.xjs");
        this.registerScript("Trsmrcv_Detail.xfdl", function() {
        ...
        ************************************************************************/
        ...
        //	this.searchVO.setColumn(0,"bbsId"  , request_id);
        	...
        	var sId 	= "Detail";
        	var sUrl 	= "svcUrl::/sym/log/tlg/InqireTrsmrcvLog_nexacro.do";
        ...
        ************************************************************************/
        ...
        this.loadIncludeScript("Trsmrcv_Detail.xfdl");
