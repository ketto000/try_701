(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"occrrncDe\" type=\"INT\" size=\"256\"/><Column id=\"rqesterId\" type=\"STRING\" size=\"256\"/><Column id=\"rqsterNm\" type=\"STRING\" size=\"256\"/><Column id=\"methodNm\" type=\"STRING\" size=\"256\"/><Column id=\"srvcNm\" type=\"STRING\" size=\"256\"/><Column id=\"creatCo\" type=\"STRING\" size=\"256\"/><Column id=\"updtCo\" type=\"STRING\" size=\"256\"/><Column id=\"rdCnt\" type=\"STRING\" size=\"256\"/><Column id=\"deleteCo\" type=\"STRING\" size=\"256\"/><Column id=\"outptCo\" type=\"STRING\" size=\"256\"/><Column id=\"errorCo\" type=\"STRING\" size=\"256\"/><Column id=\"searchBgnDe\" type=\"STRING\" size=\"256\"/><Column id=\"searchCnd\" type=\"STRING\" size=\"256\"/><Column id=\"searchEndDe\" type=\"STRING\" size=\"256\"/><Column id=\"searchWrd\" type=\"STRING\" size=\"256\"/><Column id=\"sortOrdr\" type=\"STRING\" size=\"256\"/><Column id=\"searchUseYn\" type=\"STRING\" size=\"256\"/><Column id=\"searchBgnDeView\" type=\"STRING\" size=\"256\"/><Column id=\"searchEndDeView\" type=\"STRING\" size=\"256\"/><Column id=\"pageIndex\" type=\"INT\" size=\"256\"/><Column id=\"pageUnit\" type=\"INT\" size=\"256\"/><Column id=\"pageSize\" type=\"INT\" size=\"256\"/><Column id=\"firstIndex\" type=\"INT\" size=\"256\"/><Column id=\"lastIndex\" type=\"INT\" size=\"256\"/><Column id=\"recordCountPerPage\" type=\"INT\" size=\"256\"/><Column id=\"rowNo\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"pageIndex\">1</Col><Col id=\"pageUnit\">10</Col><Col id=\"pageSize\">10</Col><Col id=\"firstIndex\">1</Col><Col id=\"lastIndex\">1</Col><Col id=\"recordCountPerPage\">10</Col><Col id=\"rowNo\">0</Col><Col id=\"occrrncDe\"/><Col id=\"rqesterId\"/><Col id=\"rqsterNm\"/><Col id=\"methodNm\"/><Col id=\"srvcNm\"/><Col id=\"updtCo\"/><Col id=\"creatCo\"/><Col id=\"rdCnt\"/><Col id=\"deleteCo\"/><Col id=\"outptCo\"/><Col id=\"errorCo\"/><Col id=\"searchBgnDe\"/><Col id=\"searchCnd\"/><Col id=\"searchEndDe\"/><Col id=\"searchWrd\"/><Col id=\"sortOrdr\"/><Col id=\"searchUseYn\"/><Col id=\"searchBgnDeView\"/><Col id=\"searchEndDeView\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"64\"/><Column size=\"105\"/><Column size=\"100\"/><Column size=\"149\"/><Column size=\"105\"/><Column size=\"72\"/><Column size=\"57\"/><Column size=\"48\"/><Column size=\"50\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"발생일자\"/><Cell col=\"2\" text=\"사용자\"/><Cell col=\"3\" text=\"메소드명\"/><Cell col=\"4\" text=\"생성\"/><Cell col=\"5\" text=\"수정\"/><Cell col=\"6\" text=\"조회\"/><Cell col=\"7\" text=\"삭제\"/><Cell col=\"8\" text=\"상세보기\"/></Band><Band id=\"body\"><Cell text=\"bind:rowNo\"/><Cell col=\"1\" text=\"bind:occrrncDe\"/><Cell col=\"2\" text=\"bind:rqsterNm\"/><Cell col=\"3\" text=\"bind:methodNm\"/><Cell col=\"4\" text=\"bind:creatCo\"/><Cell col=\"5\" text=\"bind:updtCo\"/><Cell col=\"6\" text=\"bind:rdCnt\"/><Cell col=\"7\" text=\"bind:deleteCo\"/><Cell col=\"8\" text=\"\" displaytype=\"buttoncontrol\" edittype=\"button\" imagestretch=\"none\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("userlog_List.xfdl","log::pagging.xjs");
        this.registerScript("userlog_List.xfdl", function() {
        ...
        */
        ...
        this.fnSearchPagging = function(nPageNo)
        {
        	...
        	var sId 	= "PAGE";
        	var sUrl 	= "svcUrl::/sym/log/ulg/SelectUserLogList_nexacro.do";
        ...
        */
        ...
        this.Grid00_oncellclick = function(obj,e)
        {
        	...
        	if(e.col == "8"){
        	 	 ...
        	 	 this.parent.rqesterId=this.resultList.getColumn(e.row, "rqesterId");
        		 this.parent.occrrncDe=this.resultList.getColumn(e.row, "occrrncDe");
        		 this.parent.srvcNm=this.resultList.getColumn(e.row, "srvcNm");
        		 this.parent.methodNm=this.resultList.getColumn(e.row, "methodNm");


        		this.parent.set_url("log::userlog_Detail.xfdl");
        ...
        */
        ...
        this.loadIncludeScript("userlog_List.xfdl");
