(function()
{
    return function()
    {
        ...
        {
            this.set_name("PrivacyLog_Detail");
            ...
            obj._setContents("<ColumnInfo><Column id=\"title_kr\" type=\"STRING\" size=\"256\"/><Column id=\"title_en\" type=\"STRING\" size=\"256\"/><Column id=\"index_column\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"title_kr\">요청ID</Col><Col id=\"index_column\">requesterId</Col><Col id=\"title_en\">requstId</Col></Row><Row><Col id=\"title_kr\">조회일시</Col><Col id=\"index_column\">inquiryDatetime</Col><Col id=\"title_en\">요청ID</Col></Row><Row><Col id=\"title_kr\">서비스명</Col><Col id=\"index_column\">serviceName</Col></Row><Row><Col id=\"title_kr\">조회정보</Col><Col id=\"index_column\">inquiryInfo</Col></Row><Row><Col id=\"title_kr\">요청자</Col><Col id=\"index_column\">requesterName</Col></Row><Row><Col id=\"title_kr\">요청자IP</Col><Col id=\"index_column\">requesterIp</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("PrivacyLog_Detail.xfdl","board::langCnt.xjs");
        this.registerScript("PrivacyLog_Detail.xfdl", function() {
        ...
        ************************************************************************/
        this.board_Detail_onload = function(obj,e)
        {
        	...
        	var strParam1=this.parent.requestId; //DIV할당된 변수
        	//alert(strParam1);

        	this.searchVO.setColumn(0,"requestId", strParam1);
        ...
        this.fnSearchDetail = function(strParam1)
        {
        	...
        	var sId 	= "Detail";
        	var sUrl 	= "svcUrl::/sym/log/plg/SelectPrivacyLogDetail_nexacro.do";
        ...
        ************************************************************************/
        ...
        {
        	this.parent.set_url("log::PrivacyLog_List.xfdl");
        };
        ...
        this.loadIncludeScript("PrivacyLog_Detail.xfdl");
